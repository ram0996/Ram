 ...
 */
package com.shopping.backoffice.jalo;
...
import com.shopping.backoffice.constants.ShoppingbackofficeConstants;
 ...
 */
public class ShoppingbackofficeManager extends GeneratedShoppingbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(ShoppingbackofficeManager.class.getName());
	 ...
	 */
	public static ShoppingbackofficeManager getInstance()
	{
		return (ShoppingbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ShoppingbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ShoppingbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ShoppingbackofficeManager called.");
		}
	}
