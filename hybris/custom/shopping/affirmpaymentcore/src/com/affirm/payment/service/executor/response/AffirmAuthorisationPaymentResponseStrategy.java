...
public class AffirmAuthorisationPaymentResponseStrategy implements AffirmPaymentResponseStrategy {
   ...
   @Override public void validateTransactionResult(AbstractOrderModel abstractOrderModel, AffirmPaymentTransactionEntryModel transactionEntry) {
      ...
      String status = transactionEntry.getProperties().get(STATUS);

      if(validAmount(amount, abstractOrderModel) && AUTHORIZED.equals(status)){
