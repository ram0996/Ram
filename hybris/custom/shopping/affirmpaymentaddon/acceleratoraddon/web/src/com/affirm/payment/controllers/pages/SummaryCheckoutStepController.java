...
public class SummaryCheckoutStepController extends AbstractCheckoutStepController
{
	private static final Logger LOGGER = Logger.getLogger(
         SummaryCheckoutStepController.class);

	private static final String SUMMARY = "summary";
   String SUMMARY_PAGE = "addon:/affirmpaymentaddon/checkout/checkoutSummaryPage"; // NOSONAR
   ...
   private void setupAffirm(Model model) {
