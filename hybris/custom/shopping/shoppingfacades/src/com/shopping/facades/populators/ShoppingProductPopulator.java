...
import com.shopping.facades.product.data.GenderData;


/**
 * Populates {@link ProductData} with genders
 */
public class ShoppingProductPopulator implements Populator<ProductModel, ProductData>
{
	...
	public void populate(final ProductModel source, final ProductData target) throws ConversionException
	{
		...
		{
			if (CollectionUtils.isNotEmpty(baseProduct.getGenders()))
			{
				final List<GenderData> genders = new ArrayList<GenderData>();
				for (final Gender gender : baseProduct.getGenders())
				{
