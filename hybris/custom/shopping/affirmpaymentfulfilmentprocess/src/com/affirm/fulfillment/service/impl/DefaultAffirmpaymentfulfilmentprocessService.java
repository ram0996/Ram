 ...
 */
package com.affirm.fulfillment.service.impl;
...
public class DefaultAffirmpaymentfulfilmentprocessService implements AffirmpaymentfulfilmentprocessService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultAffirmpaymentfulfilmentprocessService.class);
	...
	{
		return DefaultAffirmpaymentfulfilmentprocessService.class.getResourceAsStream("/affirmpaymentfulfilmentprocess/sap-hybris-platform.png");
	}
