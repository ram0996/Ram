 ...
 */
package com.shopping.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(ShoppingFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(ShoppingFulfilmentProcessConstants.PARENT_PROCESS);
