...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/shoppingstorefront/electronics/en",
						"https://electronics.local:9002/shoppingstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/shoppingstorefront/electronics/en",
						"https://electronics.local:9002/shoppingstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/shoppingstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/shoppingstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/shoppingstorefront/electronics/en",
						"https://electronics.local:9002/shoppingstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/shoppingstorefront",
						"https://electronics.local:9002/shoppingstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/shoppingstorefront",
						"https://electronics.local:9002/shoppingstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/shoppingstorefront/electronics/en",
						"https://electronics.local:9002/shoppingstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
