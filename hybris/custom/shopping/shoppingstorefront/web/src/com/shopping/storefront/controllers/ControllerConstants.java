 ...
 */
package com.shopping.storefront.controllers;
...
public interface ControllerConstants
{
	...
	interface Actions
	{
		interface Cms // NOSONAR
		{
			...
			String ShoppingVideoCmsComponent = _Prefix + ShoppingVideoComponentModel._TYPECODE + _Suffix;
			String TrainingCmsComponent = _Prefix + TrainingComponentModel._TYPECODE + _Suffix;
		}
	}
	...
	interface Views
	{
		...
		interface Pages
		{
			...
			interface MultiStepCheckout // NOSONAR
			{
				...
				String RegulationPage = "pages/checkout/multi/regulationMethodPage";
			}
