...
<c:choose>
    ...
    <c:otherwise>
        ...
        <c:if test="${product.variantType eq 'ShoppingStyleVariantProduct'}">
            <c:set var="variantStyles" value="${product.variantOptions}"/>
        </c:if>
        <c:if test="${(not empty product.baseOptions[0].options) and (product.baseOptions[0].variantType eq 'ShoppingStyleVariantProduct')}">
        ...
        <c:if test="${(not empty product.baseOptions[1].options) and (product.baseOptions[0].variantType eq 'ShoppingSizeVariantProduct')}">
