 ...
 */
package com.shopping.core.batch.task;
...
public class BatchIntegrationTest extends ServicelayerTest
{
	...
	public void setUp() throws Exception
	{
		...
		importCsv("/shoppingcore/test/testBatch.impex", "utf-8");
	...
	public void testVariant() throws Exception
	{
		...
		final ShoppingStyleVariantProductModel variant = (ShoppingStyleVariantProductModel) productService.getProductForCode(variantId
				.toString());
		Assert.assertEquals("ShoppingStyleVariantProduct", product.getVariantType().getCode());
