 ...
 */
package com.shopping.core.constants;

/**
 * Global class for all ShoppingCore constants. You can add global constants for your extension into this class.
 */
public final class ShoppingCoreConstants extends GeneratedShoppingCoreConstants
{
	public static final String EXTENSIONNAME = "shoppingcore";


	private ShoppingCoreConstants()
	{
		//empty
	}
