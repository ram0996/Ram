...
import com.shopping.core.enums.SwatchColorEnum;
...
public class ColorFacetValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider
{
	...
	{
		final ShoppingStyleVariantProductModel shoppingStyleModel = getShoppingStyleProductModel(model);
		if (shoppingStyleModel == null)
		{
			return Collections.emptyList();
		}

		final Set<SwatchColorEnum> colors = shoppingStyleModel.getSwatchColors();
	...
	protected ShoppingStyleVariantProductModel getShoppingStyleProductModel(final Object model)
	{
		...
		{
			return (ShoppingStyleVariantProductModel) finalModel;
		}
		else
		{
			return null;
