 ...
 */
package com.shopping.web.services.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import de.hybris.platform.webservicescommons.swagger.services.ApiVendorExtensionService;
import com.shopping.web.services.constants.YcommercewebservicesConstants;
import com.shopping.web.services.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "shoppingwebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "shoppingwebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "shoppingwebservices.oauth2.tokenUrl";

	private static final String DESC = "shoppingwebservices.v2.description";
	private static final String TITLE = "shoppingwebservices.v2.title";
	private static final String VERSION = "shoppingwebservices.v2.version";
	private static final String LICENSE = "shoppingwebservices.v2.license";
	private static final String LICENSE_URL = "shoppingwebservices.v2.license.url";
