 ...
 */
package com.shopping.test.setup;
...
import com.shopping.test.constants.ShoppingTestConstants;
import com.shopping.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = ShoppingTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/shoppingtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/shoppingtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/shoppingtest/import/cstickets.impex");
			...
			importImpexFile(context, "/shoppingtest/import/csquotes.impex");
		}
	}
}
