 ...
 */
package com.cg.fashion.test.setup;
...
import com.cg.fashion.test.constants.FashionTestConstants;
import com.cg.fashion.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = FashionTestConstants.EXTENSIONNAME)
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			else
			{
				...
				importImpexFile(context, "/fashiontest/import/qa-test-users.impex");

				LOG.info("Creating Reviews...");
				importImpexFile(context, "/fashiontest/import/reviews.impex");
				...
				importImpexFile(context, "/fashiontest/import/cstickets.impex");

				LOG.info("Creating Test Quotes...");
				importImpexFile(context, "/fashiontest/import/csquotes.impex");
			}
		}
	}
}
