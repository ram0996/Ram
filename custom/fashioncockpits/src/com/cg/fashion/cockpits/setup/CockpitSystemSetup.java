 ...
 */
package com.cg.fashion.cockpits.setup;
...
import com.cg.fashion.cockpits.constants.FashionCockpitsConstants;
 ...
 */
@SystemSetup(extension = FashionCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(FashionCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(FashionCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						FashionCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/fashioncockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
