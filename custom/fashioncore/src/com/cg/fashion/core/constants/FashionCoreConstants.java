...
/**
 * Global class for all FashionCore constants. You can add global constants for your extension into this class.
 */
public final class FashionCoreConstants extends GeneratedFashionCoreConstants
{
	public static final String EXTENSIONNAME = "fashioncore";


	private FashionCoreConstants()
	{
		//empty
	}
