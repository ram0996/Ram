...
/**
 * Generated class for type {@link com.cg.fashion.core.jalo.FashionStyleVariantProduct FashionStyleVariantProduct}.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedFashionStyleVariantProduct extends VariantProduct
{
	/** Qualifier of the <code>FashionStyleVariantProduct.style</code> attribute **/
	public static final String STYLE = "style";
	/** Qualifier of the <code>FashionStyleVariantProduct.swatchColors</code> attribute **/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>FashionStyleVariantProduct.style</code> attribute.
	...
	public String getStyle(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedFashionStyleVariantProduct.getStyle requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>FashionStyleVariantProduct.style</code> attribute. 
	...
	public void setStyle(final SessionContext ctx, final String value)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedFashionStyleVariantProduct.setStyle requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>FashionStyleVariantProduct.swatchColors</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>FashionStyleVariantProduct.swatchColors</code> attribute. 
