...
/**
 * Generated class for type {@link com.cg.fashion.core.jalo.FashionSizeVariantProduct FashionSizeVariantProduct}.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedFashionSizeVariantProduct extends FashionStyleVariantProduct
{
	/** Qualifier of the <code>FashionSizeVariantProduct.size</code> attribute **/
	public static final String SIZE = "size";
	protected static final Map<String, AttributeMode> DEFAULT_INITIAL_ATTRIBUTES;
	static
	{
		final Map<String, AttributeMode> tmp = new HashMap<String, AttributeMode>(FashionStyleVariantProduct.DEFAULT_INITIAL_ATTRIBUTES);
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>FashionSizeVariantProduct.size</code> attribute.
	...
	public String getSize(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedFashionSizeVariantProduct.getSize requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>FashionSizeVariantProduct.size</code> attribute. 
	...
	public void setSize(final SessionContext ctx, final String value)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedFashionSizeVariantProduct.setSize requires a session language", 0 );
		}
