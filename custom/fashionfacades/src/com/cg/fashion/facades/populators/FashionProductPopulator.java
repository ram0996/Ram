 ...
 */
package com.cg.fashion.facades.populators;
...
import com.cg.fashion.core.model.FashionProductModel;
import com.cg.fashion.facades.product.data.GenderData;


/**
 * Populates {@link ProductData} with genders
 */
public class FashionProductPopulator implements Populator<ProductModel, ProductData>
{
	...
	public void populate(final ProductModel source, final ProductData target) throws ConversionException
	{
		...
		if (baseProduct instanceof FashionProductModel)
		{
			final FashionProductModel fashionProductModel = (FashionProductModel) baseProduct;
			if (CollectionUtils.isNotEmpty(fashionProductModel.getGenders()))
			{
				final List<GenderData> genders = new ArrayList<GenderData>();
				for (final Gender gender : fashionProductModel.getGenders())
				{
