...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/fashionstorefront/electronics/en",
						"https://electronics.local:9002/fashionstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/fashionstorefront/electronics/en",
						"https://electronics.local:9002/fashionstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/fashionstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/fashionstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/fashionstorefront/electronics/en",
						"https://electronics.local:9002/fashionstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/fashionstorefront",
						"https://electronics.local:9002/fashionstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/fashionstorefront",
						"https://electronics.local:9002/fashionstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/fashionstorefront/electronics/en",
						"https://electronics.local:9002/fashionstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
