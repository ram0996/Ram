 ...
 */
package com.cg.fashion.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(FashionFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(FashionFulfilmentProcessConstants.PARENT_PROCESS);
